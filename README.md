...
プロジェクトをセットアップする際に以下のように指定をしておく。
...
Nextjs ver11.0 対応で、次のレクチャーの Layout component で下記修正をお願いいたします。
...
Jest 系の update の影響で、レクチャーのテスト実行時に 2 つのエラーが発生する可能性がありますので、遭遇した場合は下記手順で対処をお願い致します。
